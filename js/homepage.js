function ativarCarrossel(containerId, scrollId, btnLeftId, btnRightId) {
...
ativarCarrossel('container-help-carousel', 'carousel-scroll-container', 'slideLeft', 'slideRight');

ativarCarrossel('unidades', 'unidades-scroll', 'btnLeftUnits', 'btnRightUnits');
